...
function RoomPageContent() {
    console.log('📄 SAYFA: /rooms/join - RoomPage AÇILDI')
        ...
        const handleGuessSubmit = async (guess: string, result: any[]) => {
            ...
            try {
                ...
                if (error) {
                    ...
                    console.log('Tahmin başarıyla işlendi, veriler yenileniyor...')
...
export default function RoomPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-dark-100 flex items-center justify-center text-white">Oda Yükleniyor...</div>}>
            <RoomPageContent />
        </Suspense>
    )
}
