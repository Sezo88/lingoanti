                ...
                <div className="glass-effect rounded-3xl p-8 shadow-2xl">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-dark-200 text-white/50">veya</span>
                        </div>
                    </div>

                    <button
                        onClick={() => handleSocialLogin('google')}
                        className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-white text-gray-700 font-bold hover:bg-gray-50 transition-all shadow-md active:scale-95 border border-gray-200"
                    >
