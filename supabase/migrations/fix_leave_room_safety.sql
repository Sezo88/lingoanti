-- FIX: Make leave_room robust against skip_turn failures
-- If skip_turn fails (e.g. invalid config), user should still be able to leave!
...
BEGIN
    ...
    -- 1. Update status to 'left' immediately
    ...
    ELSIF v_room.status = 'playing' THEN
        ...
        EXCEPTION WHEN OTHERS THEN
            -- Log error but DO NOT FAIL the leave operation
            RAISE WARNING 'Error in skip_turn logic during leave: %', SQLERRM;
        END;
