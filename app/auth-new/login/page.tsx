                ...
                <div className="glass-effect rounded-3xl p-8 shadow-2xl">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 py-3 rounded-xl bg-white text-dark-900 font-semibold hover:bg-gray-100 transition-colors"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-2 py-3 rounded-xl bg-[#1877F2] text-white font-semibold hover:bg-[#166fe5] transition-colors"
                        >
                            <img src="https://www.svgrepo.com/show/475647/facebook-color.svg" alt="Facebook" className="w-5 h-5 invert brightness-0 saturate-100 invert-100" />
                            Facebook
                        </button>
                    </div>
