-- LEAVE ROOM LOGIC V4 (Final Fix)
-- Fixed: Removed invalid enum value "connected" which caused DB error.
-- Enum values allowed: active, left, disconnected, finished, ready, playing.
...
BEGIN
    ...
    -- Fixed: Removed "connected" (invalid enum)
