...
function TournamentLobbyContent() {
    ...
    const lobbyId = searchParams.get('id') as string
                ...
                <div className="glass-effect p-6 rounded-2xl mb-6">
                    ...
                    {!isLeader && (
                        <div className="text-center text-white/60 text-sm">
                            Lider aramayı başlattığında tüm takım üyeleri otomatik olarak oyuna bağlanacaktır.
                        </div>
                    )}
                </div>
...
export default function TournamentLobbyPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-dark-100 flex items-center justify-center text-white">Lobi Yükleniyor...</div>}>
